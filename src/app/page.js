...
export default function Home() {
  return (
    <main className="max-w-8xl mx-auto px-4 sm:px-6 md:px-8 py-8 md:py-12 pt-35npm flex flex-col pt-16 md:pt-55 items-center justify-center text-center text-text-primary">
