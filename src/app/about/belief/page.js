export default function BelievePage() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-8 md:py-12 mt-16 md:mt-45">
      <h2 className="text-lg sm:text-xl mb-4 text-text-primary font-medium">
        What We Believe
      </h2>

      {paragraphs.map((text, index) => (
        <p key={index} className="mb-6 md:mb-8 text-base sm:text-lg text-text-primary leading-relaxed">
